        ...
        <div class="body-content">
            ...
            if ($_SESSION['userDetails']['gold_status'] === "approved") {
                echo (' <div class="balance-card">
                  <h1>Gold Savings Plan</h1>
            
                  <span id="chit-blance"><b>Total Amount</b> : ' . $_SESSION['userDetails']['gold_amount'] * 12 . '</span></br>
                  <span id="chit-blance"><b>Due Amount</b> : ' . $_SESSION['userDetails']['gold_amount'] . '</span>
              </div>
