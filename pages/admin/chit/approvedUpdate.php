...
if (isset($_POST["SendRequest"])) {
    ...
    $sql = "UPDATE `chit_funds_table` SET `blance_amount` = '$new_balance', `paid_amount` = '$new_pay', `next_due` = '$next_due' WHERE `chit_funds_table`.`userId` = '$id'";
    $result = $db->query($sql);
    if ($result == TRUE) {
        echo '<script> 
...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM `chit_funds_table` WHERE `userId`='$user_id'";
    ...
    if ($result->num_rows > 0) {
        ...
        $balanceamonubt = $row['blance_amount'];
        ...
        <form class="form" method="POST">
            <div class="form-layout text-center">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="blance_amount" value="<?php echo $balanceamonubt; ?>">
                ...
                <div class="form-group">
                    <input type="number" class="form-control" placeholder="Next Due Amount" name="next_due"
                        autocomplete="off">
                </div>
